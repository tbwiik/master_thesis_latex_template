...
Page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill page fill.

\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.9\textwidth]{Figures/trajectory angle.png}
...
\begin{figure}[p]
  \centering
  \subfloat[Time as a linear variable.]{\includegraphics[width=0.6\textwidth]{Figures/diurnal_values_linear.png}\label{fig:diurnal_lin}}
  \vspace{0.15cm}
  
  \subfloat[Time represented as pairs of sine and cosine.]{\includegraphics[width=0.6\textwidth]{Figures/diurnal_values_sine.png}\label{fig:diurnal_trig}}
  \vspace{0.15cm}
  
  \subfloat[Time as a cyclic feature.]{\includegraphics[width=0.4\textwidth]{Figures/diurnal_values_circle.png}\label{fig:diurnal_cyclic}}
