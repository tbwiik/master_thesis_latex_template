...
\begin{titlepage}
\newgeometry{left=0.14\paperwidth, right=0.14\paperwidth, top=0.12\paperheight, bottom=0.12\paperheight}
\vspace*{3\baselineskip}

{\raggedright
\textcolor{gray}{\large Nina Salvesen}\par
\vspace{2\baselineskip}

\textbf{\Large The title of your master's thesis should be written here}\par
\vspace{\baselineskip}

{\large Any undertitle is written here}\par
}

\vfill

{\raggedright
Master's thesis in Physics and Mathematics\par
Supervisor: Supervisor Name\par
Co-supervisor: Co-supervisor Name\par
June 2022\par

\vspace{\baselineskip}
Norwegian University of Science and Technology\par
Faculty of Natural Sciences\par
